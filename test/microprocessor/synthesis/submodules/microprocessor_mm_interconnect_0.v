...
module microprocessor_mm_interconnect_0 (
		...
		output wire [1:0]  arrivalSignals_s1_address,               //                 arrivalSignals_s1.address
		output wire        arrivalSignals_s1_write,                 //                                  .write
		input  wire [31:0] arrivalSignals_s1_readdata,              //                                  .readdata
		output wire [31:0] arrivalSignals_s1_writedata,             //                                  .writedata
		output wire        arrivalSignals_s1_chipselect,            //                                  .chipselect
		output wire [1:0]  depressurize_s1_address,                 //                   depressurize_s1.address
		output wire        depressurize_s1_write,                   //                                  .write
		input  wire [31:0] depressurize_s1_readdata,                //                                  .readdata
		output wire [31:0] depressurize_s1_writedata,               //                                  .writedata
		output wire        depressurize_s1_chipselect,              //                                  .chipselect
		output wire [1:0]  doors_s1_address,                        //                          doors_s1.address
		output wire        doors_s1_write,                          //                                  .write
		input  wire [31:0] doors_s1_readdata,                       //                                  .readdata
		output wire [31:0] doors_s1_writedata,                      //                                  .writedata
		output wire        doors_s1_chipselect,                     //                                  .chipselect
		...
		output wire [1:0]  pressurize_s1_address,                   //                     pressurize_s1.address
		output wire        pressurize_s1_write,                     //                                  .write
		input  wire [31:0] pressurize_s1_readdata,                  //                                  .readdata
		output wire [31:0] pressurize_s1_writedata,                 //                                  .writedata
		output wire        pressurize_s1_chipselect                 //                                  .chipselect
	);
	...
	wire  [31:0] arrivalsignals_s1_agent_m0_readdata;                                         // arrivalSignals_s1_translator:uav_readdata -> arrivalSignals_s1_agent:m0_readdata
	wire         arrivalsignals_s1_agent_m0_waitrequest;                                      // arrivalSignals_s1_translator:uav_waitrequest -> arrivalSignals_s1_agent:m0_waitrequest
	wire         arrivalsignals_s1_agent_m0_debugaccess;                                      // arrivalSignals_s1_agent:m0_debugaccess -> arrivalSignals_s1_translator:uav_debugaccess
	wire  [13:0] arrivalsignals_s1_agent_m0_address;                                          // arrivalSignals_s1_agent:m0_address -> arrivalSignals_s1_translator:uav_address
	wire   [3:0] arrivalsignals_s1_agent_m0_byteenable;                                       // arrivalSignals_s1_agent:m0_byteenable -> arrivalSignals_s1_translator:uav_byteenable
	wire         arrivalsignals_s1_agent_m0_read;                                             // arrivalSignals_s1_agent:m0_read -> arrivalSignals_s1_translator:uav_read
	wire         arrivalsignals_s1_agent_m0_readdatavalid;                                    // arrivalSignals_s1_translator:uav_readdatavalid -> arrivalSignals_s1_agent:m0_readdatavalid
	wire         arrivalsignals_s1_agent_m0_lock;                                             // arrivalSignals_s1_agent:m0_lock -> arrivalSignals_s1_translator:uav_lock
	wire  [31:0] arrivalsignals_s1_agent_m0_writedata;                                        // arrivalSignals_s1_agent:m0_writedata -> arrivalSignals_s1_translator:uav_writedata
	wire         arrivalsignals_s1_agent_m0_write;                                            // arrivalSignals_s1_agent:m0_write -> arrivalSignals_s1_translator:uav_write
	wire   [2:0] arrivalsignals_s1_agent_m0_burstcount;                                       // arrivalSignals_s1_agent:m0_burstcount -> arrivalSignals_s1_translator:uav_burstcount
	wire         arrivalsignals_s1_agent_rf_source_valid;                                     // arrivalSignals_s1_agent:rf_source_valid -> arrivalSignals_s1_agent_rsp_fifo:in_valid
	wire  [90:0] arrivalsignals_s1_agent_rf_source_data;                                      // arrivalSignals_s1_agent:rf_source_data -> arrivalSignals_s1_agent_rsp_fifo:in_data
	wire         arrivalsignals_s1_agent_rf_source_ready;                                     // arrivalSignals_s1_agent_rsp_fifo:in_ready -> arrivalSignals_s1_agent:rf_source_ready
	wire         arrivalsignals_s1_agent_rf_source_startofpacket;                             // arrivalSignals_s1_agent:rf_source_startofpacket -> arrivalSignals_s1_agent_rsp_fifo:in_startofpacket
	wire         arrivalsignals_s1_agent_rf_source_endofpacket;                               // arrivalSignals_s1_agent:rf_source_endofpacket -> arrivalSignals_s1_agent_rsp_fifo:in_endofpacket
	wire         arrivalsignals_s1_agent_rsp_fifo_out_valid;                                  // arrivalSignals_s1_agent_rsp_fifo:out_valid -> arrivalSignals_s1_agent:rf_sink_valid
	wire  [90:0] arrivalsignals_s1_agent_rsp_fifo_out_data;                                   // arrivalSignals_s1_agent_rsp_fifo:out_data -> arrivalSignals_s1_agent:rf_sink_data
	wire         arrivalsignals_s1_agent_rsp_fifo_out_ready;                                  // arrivalSignals_s1_agent:rf_sink_ready -> arrivalSignals_s1_agent_rsp_fifo:out_ready
	wire         arrivalsignals_s1_agent_rsp_fifo_out_startofpacket;                          // arrivalSignals_s1_agent_rsp_fifo:out_startofpacket -> arrivalSignals_s1_agent:rf_sink_startofpacket
	wire         arrivalsignals_s1_agent_rsp_fifo_out_endofpacket;                            // arrivalSignals_s1_agent_rsp_fifo:out_endofpacket -> arrivalSignals_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> arrivalSignals_s1_agent:cp_valid
	wire  [89:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> arrivalSignals_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // arrivalSignals_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> arrivalSignals_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> arrivalSignals_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> arrivalSignals_s1_agent:cp_endofpacket
	wire  [31:0] doors_s1_agent_m0_readdata;                                                  // doors_s1_translator:uav_readdata -> doors_s1_agent:m0_readdata
	wire         doors_s1_agent_m0_waitrequest;                                               // doors_s1_translator:uav_waitrequest -> doors_s1_agent:m0_waitrequest
	wire         doors_s1_agent_m0_debugaccess;                                               // doors_s1_agent:m0_debugaccess -> doors_s1_translator:uav_debugaccess
	wire  [13:0] doors_s1_agent_m0_address;                                                   // doors_s1_agent:m0_address -> doors_s1_translator:uav_address
	wire   [3:0] doors_s1_agent_m0_byteenable;                                                // doors_s1_agent:m0_byteenable -> doors_s1_translator:uav_byteenable
	wire         doors_s1_agent_m0_read;                                                      // doors_s1_agent:m0_read -> doors_s1_translator:uav_read
	wire         doors_s1_agent_m0_readdatavalid;                                             // doors_s1_translator:uav_readdatavalid -> doors_s1_agent:m0_readdatavalid
	wire         doors_s1_agent_m0_lock;                                                      // doors_s1_agent:m0_lock -> doors_s1_translator:uav_lock
	wire  [31:0] doors_s1_agent_m0_writedata;                                                 // doors_s1_agent:m0_writedata -> doors_s1_translator:uav_writedata
	wire         doors_s1_agent_m0_write;                                                     // doors_s1_agent:m0_write -> doors_s1_translator:uav_write
	wire   [2:0] doors_s1_agent_m0_burstcount;                                                // doors_s1_agent:m0_burstcount -> doors_s1_translator:uav_burstcount
	wire         doors_s1_agent_rf_source_valid;                                              // doors_s1_agent:rf_source_valid -> doors_s1_agent_rsp_fifo:in_valid
	wire  [90:0] doors_s1_agent_rf_source_data;                                               // doors_s1_agent:rf_source_data -> doors_s1_agent_rsp_fifo:in_data
	wire         doors_s1_agent_rf_source_ready;                                              // doors_s1_agent_rsp_fifo:in_ready -> doors_s1_agent:rf_source_ready
	wire         doors_s1_agent_rf_source_startofpacket;                                      // doors_s1_agent:rf_source_startofpacket -> doors_s1_agent_rsp_fifo:in_startofpacket
	wire         doors_s1_agent_rf_source_endofpacket;                                        // doors_s1_agent:rf_source_endofpacket -> doors_s1_agent_rsp_fifo:in_endofpacket
	wire         doors_s1_agent_rsp_fifo_out_valid;                                           // doors_s1_agent_rsp_fifo:out_valid -> doors_s1_agent:rf_sink_valid
	wire  [90:0] doors_s1_agent_rsp_fifo_out_data;                                            // doors_s1_agent_rsp_fifo:out_data -> doors_s1_agent:rf_sink_data
	wire         doors_s1_agent_rsp_fifo_out_ready;                                           // doors_s1_agent:rf_sink_ready -> doors_s1_agent_rsp_fifo:out_ready
	wire         doors_s1_agent_rsp_fifo_out_startofpacket;                                   // doors_s1_agent_rsp_fifo:out_startofpacket -> doors_s1_agent:rf_sink_startofpacket
	wire         doors_s1_agent_rsp_fifo_out_endofpacket;                                     // doors_s1_agent_rsp_fifo:out_endofpacket -> doors_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> doors_s1_agent:cp_valid
	wire  [89:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> doors_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // doors_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> doors_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> doors_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> doors_s1_agent:cp_endofpacket
	wire  [31:0] pressurize_s1_agent_m0_readdata;                                             // pressurize_s1_translator:uav_readdata -> pressurize_s1_agent:m0_readdata
	wire         pressurize_s1_agent_m0_waitrequest;                                          // pressurize_s1_translator:uav_waitrequest -> pressurize_s1_agent:m0_waitrequest
	wire         pressurize_s1_agent_m0_debugaccess;                                          // pressurize_s1_agent:m0_debugaccess -> pressurize_s1_translator:uav_debugaccess
	wire  [13:0] pressurize_s1_agent_m0_address;                                              // pressurize_s1_agent:m0_address -> pressurize_s1_translator:uav_address
	wire   [3:0] pressurize_s1_agent_m0_byteenable;                                           // pressurize_s1_agent:m0_byteenable -> pressurize_s1_translator:uav_byteenable
	wire         pressurize_s1_agent_m0_read;                                                 // pressurize_s1_agent:m0_read -> pressurize_s1_translator:uav_read
	wire         pressurize_s1_agent_m0_readdatavalid;                                        // pressurize_s1_translator:uav_readdatavalid -> pressurize_s1_agent:m0_readdatavalid
	wire         pressurize_s1_agent_m0_lock;                                                 // pressurize_s1_agent:m0_lock -> pressurize_s1_translator:uav_lock
	wire  [31:0] pressurize_s1_agent_m0_writedata;                                            // pressurize_s1_agent:m0_writedata -> pressurize_s1_translator:uav_writedata
	wire         pressurize_s1_agent_m0_write;                                                // pressurize_s1_agent:m0_write -> pressurize_s1_translator:uav_write
	wire   [2:0] pressurize_s1_agent_m0_burstcount;                                           // pressurize_s1_agent:m0_burstcount -> pressurize_s1_translator:uav_burstcount
	wire         pressurize_s1_agent_rf_source_valid;                                         // pressurize_s1_agent:rf_source_valid -> pressurize_s1_agent_rsp_fifo:in_valid
	wire  [90:0] pressurize_s1_agent_rf_source_data;                                          // pressurize_s1_agent:rf_source_data -> pressurize_s1_agent_rsp_fifo:in_data
	wire         pressurize_s1_agent_rf_source_ready;                                         // pressurize_s1_agent_rsp_fifo:in_ready -> pressurize_s1_agent:rf_source_ready
	wire         pressurize_s1_agent_rf_source_startofpacket;                                 // pressurize_s1_agent:rf_source_startofpacket -> pressurize_s1_agent_rsp_fifo:in_startofpacket
	wire         pressurize_s1_agent_rf_source_endofpacket;                                   // pressurize_s1_agent:rf_source_endofpacket -> pressurize_s1_agent_rsp_fifo:in_endofpacket
	wire         pressurize_s1_agent_rsp_fifo_out_valid;                                      // pressurize_s1_agent_rsp_fifo:out_valid -> pressurize_s1_agent:rf_sink_valid
	wire  [90:0] pressurize_s1_agent_rsp_fifo_out_data;                                       // pressurize_s1_agent_rsp_fifo:out_data -> pressurize_s1_agent:rf_sink_data
	wire         pressurize_s1_agent_rsp_fifo_out_ready;                                      // pressurize_s1_agent:rf_sink_ready -> pressurize_s1_agent_rsp_fifo:out_ready
	wire         pressurize_s1_agent_rsp_fifo_out_startofpacket;                              // pressurize_s1_agent_rsp_fifo:out_startofpacket -> pressurize_s1_agent:rf_sink_startofpacket
	wire         pressurize_s1_agent_rsp_fifo_out_endofpacket;                                // pressurize_s1_agent_rsp_fifo:out_endofpacket -> pressurize_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> pressurize_s1_agent:cp_valid
	wire  [89:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pressurize_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // pressurize_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> pressurize_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> pressurize_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> pressurize_s1_agent:cp_endofpacket
	wire  [31:0] depressurize_s1_agent_m0_readdata;                                           // depressurize_s1_translator:uav_readdata -> depressurize_s1_agent:m0_readdata
	wire         depressurize_s1_agent_m0_waitrequest;                                        // depressurize_s1_translator:uav_waitrequest -> depressurize_s1_agent:m0_waitrequest
	wire         depressurize_s1_agent_m0_debugaccess;                                        // depressurize_s1_agent:m0_debugaccess -> depressurize_s1_translator:uav_debugaccess
	wire  [13:0] depressurize_s1_agent_m0_address;                                            // depressurize_s1_agent:m0_address -> depressurize_s1_translator:uav_address
	wire   [3:0] depressurize_s1_agent_m0_byteenable;                                         // depressurize_s1_agent:m0_byteenable -> depressurize_s1_translator:uav_byteenable
	wire         depressurize_s1_agent_m0_read;                                               // depressurize_s1_agent:m0_read -> depressurize_s1_translator:uav_read
	wire         depressurize_s1_agent_m0_readdatavalid;                                      // depressurize_s1_translator:uav_readdatavalid -> depressurize_s1_agent:m0_readdatavalid
	wire         depressurize_s1_agent_m0_lock;                                               // depressurize_s1_agent:m0_lock -> depressurize_s1_translator:uav_lock
	wire  [31:0] depressurize_s1_agent_m0_writedata;                                          // depressurize_s1_agent:m0_writedata -> depressurize_s1_translator:uav_writedata
	wire         depressurize_s1_agent_m0_write;                                              // depressurize_s1_agent:m0_write -> depressurize_s1_translator:uav_write
	wire   [2:0] depressurize_s1_agent_m0_burstcount;                                         // depressurize_s1_agent:m0_burstcount -> depressurize_s1_translator:uav_burstcount
	wire         depressurize_s1_agent_rf_source_valid;                                       // depressurize_s1_agent:rf_source_valid -> depressurize_s1_agent_rsp_fifo:in_valid
	wire  [90:0] depressurize_s1_agent_rf_source_data;                                        // depressurize_s1_agent:rf_source_data -> depressurize_s1_agent_rsp_fifo:in_data
	wire         depressurize_s1_agent_rf_source_ready;                                       // depressurize_s1_agent_rsp_fifo:in_ready -> depressurize_s1_agent:rf_source_ready
	wire         depressurize_s1_agent_rf_source_startofpacket;                               // depressurize_s1_agent:rf_source_startofpacket -> depressurize_s1_agent_rsp_fifo:in_startofpacket
	wire         depressurize_s1_agent_rf_source_endofpacket;                                 // depressurize_s1_agent:rf_source_endofpacket -> depressurize_s1_agent_rsp_fifo:in_endofpacket
	wire         depressurize_s1_agent_rsp_fifo_out_valid;                                    // depressurize_s1_agent_rsp_fifo:out_valid -> depressurize_s1_agent:rf_sink_valid
	wire  [90:0] depressurize_s1_agent_rsp_fifo_out_data;                                     // depressurize_s1_agent_rsp_fifo:out_data -> depressurize_s1_agent:rf_sink_data
	wire         depressurize_s1_agent_rsp_fifo_out_ready;                                    // depressurize_s1_agent:rf_sink_ready -> depressurize_s1_agent_rsp_fifo:out_ready
	wire         depressurize_s1_agent_rsp_fifo_out_startofpacket;                            // depressurize_s1_agent_rsp_fifo:out_startofpacket -> depressurize_s1_agent:rf_sink_startofpacket
	wire         depressurize_s1_agent_rsp_fifo_out_endofpacket;                              // depressurize_s1_agent_rsp_fifo:out_endofpacket -> depressurize_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> depressurize_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> depressurize_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // depressurize_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> depressurize_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> depressurize_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> depressurize_s1_agent:cp_endofpacket
	...
	wire         arrivalsignals_s1_agent_rp_valid;                                            // arrivalSignals_s1_agent:rp_valid -> router_005:sink_valid
	wire  [89:0] arrivalsignals_s1_agent_rp_data;                                             // arrivalSignals_s1_agent:rp_data -> router_005:sink_data
	wire         arrivalsignals_s1_agent_rp_ready;                                            // router_005:sink_ready -> arrivalSignals_s1_agent:rp_ready
	wire         arrivalsignals_s1_agent_rp_startofpacket;                                    // arrivalSignals_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         arrivalsignals_s1_agent_rp_endofpacket;                                      // arrivalSignals_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         doors_s1_agent_rp_valid;                                                     // doors_s1_agent:rp_valid -> router_006:sink_valid
	wire  [89:0] doors_s1_agent_rp_data;                                                      // doors_s1_agent:rp_data -> router_006:sink_data
	wire         doors_s1_agent_rp_ready;                                                     // router_006:sink_ready -> doors_s1_agent:rp_ready
	wire         doors_s1_agent_rp_startofpacket;                                             // doors_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         doors_s1_agent_rp_endofpacket;                                               // doors_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pressurize_s1_agent_rp_valid;                                                // pressurize_s1_agent:rp_valid -> router_007:sink_valid
	wire  [89:0] pressurize_s1_agent_rp_data;                                                 // pressurize_s1_agent:rp_data -> router_007:sink_data
	wire         pressurize_s1_agent_rp_ready;                                                // router_007:sink_ready -> pressurize_s1_agent:rp_ready
	wire         pressurize_s1_agent_rp_startofpacket;                                        // pressurize_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pressurize_s1_agent_rp_endofpacket;                                          // pressurize_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         depressurize_s1_agent_rp_valid;                                              // depressurize_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] depressurize_s1_agent_rp_data;                                               // depressurize_s1_agent:rp_data -> router_008:sink_data
	wire         depressurize_s1_agent_rp_ready;                                              // router_008:sink_ready -> depressurize_s1_agent:rp_ready
	wire         depressurize_s1_agent_rp_startofpacket;                                      // depressurize_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         depressurize_s1_agent_rp_endofpacket;                                        // depressurize_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         arrivalsignals_s1_agent_rdata_fifo_src_valid;                                // arrivalSignals_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] arrivalsignals_s1_agent_rdata_fifo_src_data;                                 // arrivalSignals_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         arrivalsignals_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_003:in_0_ready -> arrivalSignals_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> arrivalSignals_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> arrivalSignals_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                           // arrivalSignals_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> arrivalSignals_s1_agent:rdata_fifo_sink_error
	wire         doors_s1_agent_rdata_fifo_src_valid;                                         // doors_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] doors_s1_agent_rdata_fifo_src_data;                                          // doors_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         doors_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> doors_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> doors_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> doors_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // doors_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> doors_s1_agent:rdata_fifo_sink_error
	wire         pressurize_s1_agent_rdata_fifo_src_valid;                                    // pressurize_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pressurize_s1_agent_rdata_fifo_src_data;                                     // pressurize_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pressurize_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_005:in_0_ready -> pressurize_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> pressurize_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> pressurize_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // pressurize_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> pressurize_s1_agent:rdata_fifo_sink_error
	wire         depressurize_s1_agent_rdata_fifo_src_valid;                                  // depressurize_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] depressurize_s1_agent_rdata_fifo_src_data;                                   // depressurize_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         depressurize_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_006:in_0_ready -> depressurize_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> depressurize_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> depressurize_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                           // depressurize_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> depressurize_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) arrivalsignals_s1_translator (
		.clk                    (clk_0_clk_clk),                            //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (arrivalsignals_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (arrivalsignals_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (arrivalsignals_s1_agent_m0_read),          //                         .read
		.uav_write              (arrivalsignals_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (arrivalsignals_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (arrivalsignals_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (arrivalsignals_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (arrivalsignals_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (arrivalsignals_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (arrivalsignals_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (arrivalsignals_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (arrivalSignals_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (arrivalSignals_s1_write),                  //                         .write
		.av_readdata            (arrivalSignals_s1_readdata),               //                         .readdata
		.av_writedata           (arrivalSignals_s1_writedata),              //                         .writedata
		.av_chipselect          (arrivalSignals_s1_chipselect),             //                         .chipselect
		.av_read                (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
		.av_beginbursttransfer  (),                                         //              (terminated)
		.av_burstcount          (),                                         //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (doors_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (doors_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (doors_s1_agent_m0_read),                  //                         .read
		.uav_write              (doors_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (doors_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (doors_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (doors_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (doors_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (doors_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (doors_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (doors_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (doors_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (doors_s1_write),                          //                         .write
		.av_readdata            (doors_s1_readdata),                       //                         .readdata
		.av_writedata           (doors_s1_writedata),                      //                         .writedata
		.av_chipselect          (doors_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pressurize_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pressurize_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (pressurize_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (pressurize_s1_agent_m0_read),             //                         .read
		.uav_write              (pressurize_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (pressurize_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (pressurize_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (pressurize_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (pressurize_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (pressurize_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (pressurize_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (pressurize_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (pressurize_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (pressurize_s1_write),                     //                         .write
		.av_readdata            (pressurize_s1_readdata),                  //                         .readdata
		.av_writedata           (pressurize_s1_writedata),                 //                         .writedata
		.av_chipselect          (pressurize_s1_chipselect),                //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) depressurize_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (depressurize_s1_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (depressurize_s1_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (depressurize_s1_agent_m0_read),           //                         .read
		.uav_write              (depressurize_s1_agent_m0_write),          //                         .write
		.uav_waitrequest        (depressurize_s1_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (depressurize_s1_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (depressurize_s1_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (depressurize_s1_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (depressurize_s1_agent_m0_writedata),      //                         .writedata
		.uav_lock               (depressurize_s1_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (depressurize_s1_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (depressurize_s1_address),                 //      avalon_anti_slave_0.address
		.av_write               (depressurize_s1_write),                   //                         .write
		.av_readdata            (depressurize_s1_readdata),                //                         .readdata
		.av_writedata           (depressurize_s1_writedata),               //                         .writedata
		.av_chipselect          (depressurize_s1_chipselect),              //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) arrivalsignals_s1_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),            //       clk_reset.reset
		.m0_address              (arrivalsignals_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (arrivalsignals_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (arrivalsignals_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (arrivalsignals_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (arrivalsignals_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (arrivalsignals_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (arrivalsignals_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (arrivalsignals_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (arrivalsignals_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (arrivalsignals_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (arrivalsignals_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (arrivalsignals_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (arrivalsignals_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (arrivalsignals_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (arrivalsignals_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (arrivalsignals_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (arrivalsignals_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (arrivalsignals_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (arrivalsignals_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (arrivalsignals_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (arrivalsignals_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (arrivalsignals_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (arrivalsignals_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (arrivalsignals_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (arrivalsignals_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (arrivalsignals_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (arrivalsignals_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (arrivalsignals_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (arrivalsignals_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) arrivalsignals_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                      //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (arrivalsignals_s1_agent_rf_source_data),             //        in.data
		.in_valid          (arrivalsignals_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (arrivalsignals_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (arrivalsignals_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (arrivalsignals_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (arrivalsignals_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (arrivalsignals_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (arrivalsignals_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (arrivalsignals_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (arrivalsignals_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (doors_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (doors_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (doors_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (doors_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (doors_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (doors_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (doors_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (doors_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (doors_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (doors_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (doors_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (doors_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (doors_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (doors_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (doors_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (doors_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (doors_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (doors_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (doors_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (doors_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (doors_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (doors_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (doors_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (doors_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (doors_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (doors_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),         //                .error
		.rdata_fifo_src_ready    (doors_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (doors_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (doors_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) doors_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (doors_s1_agent_rf_source_data),             //        in.data
		.in_valid          (doors_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (doors_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (doors_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (doors_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (doors_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (doors_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (doors_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (doors_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (doors_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (pressurize_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (pressurize_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (pressurize_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (pressurize_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (pressurize_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (pressurize_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (pressurize_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (pressurize_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (pressurize_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (pressurize_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (pressurize_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (pressurize_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (pressurize_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (pressurize_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (pressurize_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (pressurize_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (pressurize_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (pressurize_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (pressurize_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (pressurize_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (pressurize_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (pressurize_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (pressurize_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (pressurize_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (pressurize_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (pressurize_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),              //                .error
		.rdata_fifo_src_ready    (pressurize_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pressurize_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (pressurize_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pressurize_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (pressurize_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pressurize_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pressurize_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pressurize_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pressurize_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pressurize_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pressurize_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pressurize_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pressurize_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pressurize_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) depressurize_s1_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (depressurize_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (depressurize_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (depressurize_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (depressurize_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (depressurize_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (depressurize_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (depressurize_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (depressurize_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (depressurize_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (depressurize_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (depressurize_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (depressurize_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (depressurize_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (depressurize_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (depressurize_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (depressurize_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (depressurize_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (depressurize_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (depressurize_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (depressurize_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (depressurize_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (depressurize_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (depressurize_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (depressurize_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (depressurize_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (depressurize_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                //                .error
		.rdata_fifo_src_ready    (depressurize_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (depressurize_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (depressurize_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) depressurize_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (depressurize_s1_agent_rf_source_data),             //        in.data
		.in_valid          (depressurize_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (depressurize_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (depressurize_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (depressurize_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (depressurize_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (depressurize_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (depressurize_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (depressurize_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (depressurize_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	microprocessor_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (arrivalsignals_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (arrivalsignals_s1_agent_rp_valid),         //          .valid
		.sink_data          (arrivalsignals_s1_agent_rp_data),          //          .data
		.sink_startofpacket (arrivalsignals_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (arrivalsignals_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	microprocessor_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (doors_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (doors_s1_agent_rp_valid),                 //          .valid
		.sink_data          (doors_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (doors_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (doors_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microprocessor_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (pressurize_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (pressurize_s1_agent_rp_valid),            //          .valid
		.sink_data          (pressurize_s1_agent_rp_data),             //          .data
		.sink_startofpacket (pressurize_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (pressurize_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microprocessor_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (depressurize_s1_agent_rp_ready),          //      sink.ready
		.sink_valid         (depressurize_s1_agent_rp_valid),          //          .valid
		.sink_data          (depressurize_s1_agent_rp_data),           //          .data
		.sink_startofpacket (depressurize_s1_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (depressurize_s1_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microprocessor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (arrivalsignals_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (arrivalsignals_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (arrivalsignals_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	microprocessor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (doors_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (doors_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (doors_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	microprocessor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (pressurize_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (pressurize_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (pressurize_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	microprocessor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (depressurize_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (depressurize_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (depressurize_s1_agent_rdata_fifo_src_ready), //         .ready
